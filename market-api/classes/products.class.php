...
class Products extends ProductCntrl {
  ...
  public function searchProduct(string $keyword, int $categoryId = null) {
    $matches = parent::searchProduct('%'.$keyword.'%', $categoryId);

    foreach($matches as $match) {
      $match->productId  = (int)$match->productId;
      $match->categoryId = (int)$match->categoryId;
